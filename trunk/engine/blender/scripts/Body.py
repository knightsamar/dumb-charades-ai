##################################################################################################
#	SCRIPT TO ANIMATE BODY(FRONT ABDOMEN PART)
#	Created, Invented and Made Alive By : Deepak Shakya
#	Date : 08-April-2008
##################################################################################################

##################################################################################################
#	This function Animates the Body(Front Abdomen Part)
#
#	Armature_Object - The Bone Armature from which it selects the Body(Abdomen) Bone to animate
...
# Body - Front Abdomen Part
def BODY(Armature_Object, direction, endFrame):
	#Defining all possible positions for the Body(Mainly the Abdomen part)
	...
	Positions = {}
	Positions["LEFT"] = [1.0,0.0,0.5,0.0]
	Positions["RIGHT"] = [1.0,0.0,-0.5,0.0]
	...
	Body = [bone for bone in all_bones if bone.name == "Bone.001"][0]
	...
	Body.quat[:] = x,y,z,r
	Body.insertKey(Armature_Object,endFrame,Object.Pose.ROT)
